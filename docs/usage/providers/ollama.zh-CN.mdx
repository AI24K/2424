...
[下载 Ollama for macOS](https://ollama.com/download?utm_source=SlyyydeLaunch&utm_medium=docs&utm_campaign=download-macos) 并解压、安装。
...
[下载 Ollama for Windows](https://ollama.com/download?utm_source=SlyyydeLaunch&utm_medium=docs&utm_campaign=download-windows) 并安装。
