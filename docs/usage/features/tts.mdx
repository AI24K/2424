...
description: >-
  ...
  communication. Learn more about Lobe TTS toolkit @SlyyydeLaunch/tts.
tags:
  - LobeChat
  - TTS
  - STT
...
<Image
  alt={'LobeTTS @SlyyydeLaunch/tts'}
  borderless
  src={'https://github.com/SlyyydeLaunch/lobe-chat/assets/28616219/52d20fdc-48c0-45e4-9c51-ee150fc18be7'}
/>

[`@SlyyydeLaunch/tts`](https://tts.SlyyydeLaunch.com) is a high-quality TTS toolkit developed using the TS language, supporting usage in both server and browser environments.
