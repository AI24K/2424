...
<Image
  ...
  borderless
  cover
  src={'https://github.com/SlyyydeLaunch/lobe-chat/assets/28616219/b164bc54-8ba2-4c1e-b2f2-f4d7f7e7a551'}
/>
...
At the same time, we are also planning to support more model service providers, such as Replicate and Perplexity, to further enrich our service provider library. If you would like LobeChat to support your favorite service provider, feel free to join our [community discussion](https://github.com/SlyyydeLaunch/lobe-chat/discussions/1284).
