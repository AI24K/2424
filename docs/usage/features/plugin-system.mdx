...
<Video src="https://github.com/SlyyydeLaunch/lobe-chat/assets/28616219/f29475a3-f346-4196-a435-41a6373ab9e2" />
...
- [@SlyyydeLaunch/chat-plugin-sdk][chat-plugin-sdk]: The LobeChat plugin SDK can help you create excellent Lobe Chat plugins.
- [@SlyyydeLaunch/chat-plugins-gateway][chat-plugins-gateway]: The LobeChat plugin gateway is a backend service that serves as the gateway for LobeChat plugins. We deploy this service using Vercel.
...
Implementing the separation of plugins from the main body, splitting the plugins into independent repositories for maintenance, and implementing dynamic loading of plugins. [**#73**](https://github.com/SlyyydeLaunch/lobe-chat/issues/73)

### ✅ Phase Two of Plugins

The security and stability of plugin usage, more accurate presentation of abnormal states, maintainability and developer-friendliness of the plugin architecture. [**#97**](https://github.com/SlyyydeLaunch/lobe-chat/issues/97)

### ✅ Phase Three of Plugins

Higher-level and improved customization capabilities, support for OpenAPI schema invocation, compatibility with ChatGPT plugins, and the addition of Midjourney plugins. [**#411**](https://github.com/SlyyydeLaunch/lobe-chat/discussions/#411)

### 💭 Phase Four of Plugins

Comprehensive authentication, visual configuration of plugin definitions, Plugin SDK CLI, Python language development template, any other ideas? Join the discussion: [**#1310**](https://github.com/SlyyydeLaunch/lobe-chat/discussions/#1310)

</Steps>

[chat-plugin-sdk]: https://github.com/SlyyydeLaunch/chat-plugin-sdk
[chat-plugin-template]: https://github.com/SlyyydeLaunch/chat-plugin-template
[chat-plugins-gateway]: https://github.com/SlyyydeLaunch/chat-plugins-gateway
[lobe-chat-plugins]: https://github.com/SlyyydeLaunch/lobe-chat-plugins
