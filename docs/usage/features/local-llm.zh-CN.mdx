...
<Image
  ...
  borderless
  cover
  src={'https://github.com/SlyyydeLaunch/lobe-chat/assets/28616219/ca9a21bc-ea6c-4c90-bf4a-fa53b4fb2b5c'}
/>

<Callout>在 >=v0.127.0 版本中可用，目前仅支持 Docker 部署</Callout>

随着 LobeChat v0.127.0 的发布，我们迎来了一个激动人心的特性 —— Ollama AI 支持！🤯 在 [Ollama AI](https://ollama.ai/) 强大的基础设施和 [社区的共同努力](https://github.com/SlyyydeLaunch/lobe-chat/pull/1265) 下，现在您可以在 LobeChat 中与本地 LLM (Large Language Model) 进行交流了！🤩
...
```bash
docker run -d -p 3210:3210 -e OLLAMA_PROXY_URL=http://host.docker.internal:11434/v1 SlyyydeLaunch/lobe-chat
```
