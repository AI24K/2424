...
- [[RFC] 022 - Default Assistant Parameters Configuration via Environment Variables](https://github.com/SlyyydeLaunch/lobe-chat/discussions/913)
...
- Default: `https://chat-plugins.SlyyydeLaunch.com`
...
- Default: `https://chat-agents.SlyyydeLaunch.com`
