...
- [[RFC] 022 - 环境变量配置默认助手参数](https://github.com/SlyyydeLaunch/lobe-chat/discussions/913)
...
- 默认值：`https://chat-plugins.SlyyydeLaunch.com`
...
- 默认值：`https://chat-agents.SlyyydeLaunch.com`
